...
@section('title', 'add new financial planning')
...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- form start -->
            <form class="form-horizontal" action="{{ route('admin.financialplanning.store') }}" method="POST"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border bg-gray-active">
                                <h3 class="box-title">Add New Financial Planning</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
